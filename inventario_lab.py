...
purezas = [
    99.5, 92.0, 99.5, 98.0, 99.9, 98.5, 96.0, 99.0, 99.0, 98.8, 99.5, 92.0, 99.2,
...
print(f"Compostos únicos identificados: {', '.join(reagentes_unicos)}\n")
...
print("--- LOTES APROVADOS PARA EXPERIMENTOS DE ALTA PUREZA (>= 98.0%) ---")
